...
public class EnrollmentController {
    ...
    public ResponseEntity<RespCommonInfo<List<RespEnrollmentDto>>> getEnrollmentInfo(@PathVariable int studentId) {

        List<RespEnrollmentDto> enrollmentList = enrollmentService.findEnrollmentById(studentId);
